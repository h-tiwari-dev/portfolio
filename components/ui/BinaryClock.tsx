...
export default function BinaryClock() {
    ...
    return (
        <div className="flex items-center space-x-3 px-3 py-1.5 bg-white/[0.03] border border-white/5 rounded-md">
            <div className="flex flex-col mr-2 pr-2 border-r border-white/5">
