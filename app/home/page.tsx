    ...
    <div>
      ...
      <div className="max-w-lg mx-auto mt-10">
        <div className="w-full">
          Hi, I am a Full Stack Software Engineer with over 3 years of professional experience. I primarily work with technologies such as MongoDB, Node.js, TypeScript, React.js, Angular.js, Nest.js, and PostgreSQL. I have experience in creating fintech products capable of scaling to thousands of requests per second.
        </div>
        <div className="mt-10">
