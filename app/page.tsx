  ...
  return (
    <main className="h-screen w-screen bg-background p-4 md:p-6 overflow-hidden flex items-center justify-center relative">
      ...
      <BentoGrid className="w-full h-full relative z-10">
        ...
        <BentoGridItem
          className="md:col-span-2 md:row-span-3 shadow-[0_0_50px_-12px_rgba(245,158,11,0.15)]"
        ...
        <BentoGridItem
          className="md:col-span-2 md:row-span-2 shadow-[0_0_30px_-12px_rgba(6,182,212,0.1)]"
          title="S_COMMS.LINK"
        >
          <Socials />
        </BentoGridItem>
        ...
        <BentoGridItem
          className="md:col-span-1 md:row-span-2 shadow-[0_0_30px_-12px_rgba(245,158,11,0.1)]"
        ...
        <BentoGridItem
          className="md:col-span-1 md:row-span-2 shadow-[0_0_30px_-12px_rgba(6,182,212,0.1)]"
