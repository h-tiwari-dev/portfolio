  ...
  return (
    <main className="min-h-screen w-full bg-background p-4 md:p-6 relative overflow-x-hidden">
      ...
      <BentoGrid className="w-full relative z-10">
        ...
        <BentoGridItem
          className="lg:col-span-1 xl:col-span-2 xl:row-span-2 shadow-[0_0_30px_-12px_rgba(6,182,212,0.1)]"
          title="S_COMMS.LINK"
        >
          <Socials />
        </BentoGridItem>
        ...
        <BentoGridItem
          className="lg:col-span-1 xl:col-span-1 xl:row-span-2 shadow-[0_0_30px_-12px_rgba(245,158,11,0.1)]"
        ...
        <BentoGridItem
          className="lg:col-span-1 xl:col-span-1 xl:row-span-2 shadow-[0_0_30px_-12px_rgba(6,182,212,0.1)]"
